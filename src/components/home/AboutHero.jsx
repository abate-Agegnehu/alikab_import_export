                  ...
                  >
                    <div className="bg-[#F9F9F9] p-8 md:p-12 border border-gray-100 rounded-2xl">
                      ...
                      <p className="mb-6 text-gray-700 text-lg leading-relaxed">
                        ...
                        transportation services from Ethiopia to key
                        destinations across Africa. Whether it's commercial
                        goods, bulk shipments, or custom logistics, we ensure
                        timely and cost-effective delivery with full
                        transparency.
                      </p>
                      <div className="gap-10 grid md:grid-cols-2">
                        <div className="space-y-4">
                          ...
                          <ul className="space-y-1 pl-1 text-gray-600 list-disc list-inside">
                            <li>
                              Cross-border cargo from Ethiopia to multiple
                              African countries
                            </li>
                            <li>Real-time tracking & secure handling</li>
                            <li>
                              Competitive pricing & custom logistics plans
                            </li>
                          </ul>
                        </div>
                        <div className="space-y-4">
                ...
                <div className="p-8">
                  ...
                  <div className="max-w-none text-[#4E4E4EB3] prose prose-lg">
                    ...
                    <p className="text-[#4E4E4EB3]">
                      ...
                      performance. We ensure every product meets rigorous
                      testing and certification requirements before being
